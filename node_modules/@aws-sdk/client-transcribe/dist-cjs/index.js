...
class TranscribeClient extends client.Client {
    ...
    constructor(...[configuration]) {
        ...
        this.middlewareStack.use(core.getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
            httpAuthSchemeParametersProvider: httpAuthSchemeProvider.defaultTranscribeHttpAuthSchemeParametersProvider,
...
const paginateListLanguageModels = core.createPaginator(TranscribeClient, ListLanguageModelsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalScribeJobs = core.createPaginator(TranscribeClient, ListMedicalScribeJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalTranscriptionJobs = core.createPaginator(TranscribeClient, ListMedicalTranscriptionJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalVocabularies = core.createPaginator(TranscribeClient, ListMedicalVocabulariesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListTranscriptionJobs = core.createPaginator(TranscribeClient, ListTranscriptionJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListVocabularies = core.createPaginator(TranscribeClient, ListVocabulariesCommand, "NextToken", "NextToken", "MaxResults");
